...
public class WorkoutRegimentFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        binding = DataBindingUtil.inflate(
                inflater, R.layout.workout_regiment_fragment, container, false);
        return binding.getRoot();
    }

    public String getWorkOutRegiment() {
        return binding.workoutRegimentDropdownMenu.getSelectedItem().toString();
    }
}
